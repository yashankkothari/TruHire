...
function createWindow(sendToRenderer, geminiSessionRef, randomNames = null) {
    ...
    let windowWidth = 1600;  // Increased for 4 panels
    let windowHeight = 900;  // Slightly taller for better content visibility

    const mainWindow = new BrowserWindow({
        width: windowWidth,
        height: windowHeight,
        minWidth: 1400,  // Minimum width to fit all 4 panels
        minHeight: 700,  // Minimum height for usability
        frame: false,
        transparent: true,
        hasShadow: false,
        alwaysOnTop: true,
